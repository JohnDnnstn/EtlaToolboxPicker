...
namespace EtlaToolboxPicker.EtlaToolbelt.Contexts;
...
public class ContextImpl : IContext
{
    ...
    /// <summary>The name of the company that owns this application.  Used when logging to a file sink.</summary>
    public string Company { get; set; } = "SRUC";
    ...
    public virtual bool IsDev() => "DEV".Equals(_EnvValue, StringComparison.InvariantCultureIgnoreCase);
    ...
    public virtual bool IsProduction() => "PRODUCTION".Equals(_EnvValue, StringComparison.InvariantCultureIgnoreCase);
